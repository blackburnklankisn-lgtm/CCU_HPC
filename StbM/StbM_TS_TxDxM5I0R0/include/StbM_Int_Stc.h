...
/* ---- Indicates the time base role regarding shared data ---- */

#if (defined STBM_TIME_BASE_NO_SHARED_DATA)
#error STBM_TIME_BASE_NO_SHARED_DATA is already defined.
#endif
/** \brief indicates that the time base parameter StbMProvideDataInSharedMemory is set to NONE
 */
#define STBM_TIME_BASE_NO_SHARED_DATA   0U

#if (defined STBM_TIME_BASE_PROVIDER_SHARED_DATA)
#error STBM_TIME_BASE_PROVIDER_SHARED_DATA is already defined.
#endif
/** \brief indicates that the time base parameter StbMProvideDataInSharedMemory is set to PROVIDER
 */
#define STBM_TIME_BASE_PROVIDER_SHARED_DATA   1U

#if (defined STBM_TIME_BASE_CONSUMER_SHARED_DATA)
#error STBM_TIME_BASE_CONSUMER_SHARED_DATA is already defined.
#endif
/** \brief indicates that the time base parameter StbMProvideDataInSharedMemory is set to CONSUMER
 */
#define STBM_TIME_BASE_CONSUMER_SHARED_DATA   2U
...
/* ---- Indicates that the time base is linked to a EthTSyn time domain ---- */

#if (defined STBM_TIMEBASE_LINKED_TO_ETHTSYN_TIMEDOMAIN)
#error STBM_TIMEBASE_LINKED_TO_ETHTSYN_TIMEDOMAIN is already defined.
#endif
/** \brief indicates that a time base is linked to a EthTSyn time domain
 */
#define STBM_TIMEBASE_LINKED_TO_ETHTSYN_TIMEDOMAIN    1U


/* ---- Indicates that the time base is linked to a EthTSyn time domain ---- */

#if (defined STBM_TIMEBASE_NOT_LINKED_TO_ETHTSYN_TIMEDOMAIN)
#error STBM_TIMEBASE_NOT_LINKED_TO_ETHTSYN_TIMEDOMAIN is already defined.
#endif
/** \brief indicates that a time base is not linked to a EthTSyn time domain
 */
#define STBM_TIMEBASE_NOT_LINKED_TO_ETHTSYN_TIMEDOMAIN    0U
...
#if (defined STBM_NO_SOURCE_TIME_BASE)
#error STBM_NO_SOURCE_TIME_BASE is already defined.
#endif
/** \brief indicates no aource time base is requested
 */
#define STBM_NO_SOURCE_TIME_BASE 255U
