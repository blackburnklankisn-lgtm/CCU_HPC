...
#if (defined STBM_CLONE_DEFERRED_COPY)
#error STBM_CLONE_DEFERRED_COPY is already defined.
#endif
/** \brief DEFERRED_COPY bit (Bit 0) in StbM_CloneConfigType
 **
 ** 0x00: Time information copied immediately to Destination Time Base.
 ** 0x01: Copy of time information to destination is deferred until Source Time base is updated next time by <bus>TSyn module.
 */
#define STBM_CLONE_DEFERRED_COPY           0x01U

#if (defined STBM_CLONE_IMMEDIATE_TX)
#error STBM_CLONE_IMMEDIATE_TX is already defined.
#endif
/** \brief IMMEDIATE_TX bit (Bit 1) in StbM_CloneConfigType
 **
 ** 0x00: Time information is transmitted on destination bus only on next cyclic transmission after cloning.
 ** 0x01: Time information is transmitted on destination bus immediately after cloning.
 */
#define STBM_CLONE_IMMEDIATE_TX           0x02U

#if (defined STBM_CLONE_APPLY_RATE)
#error STBM_CLONE_APPLY_RATE is already defined.
#endif
/** \brief APPLY_RATE bit (Bit 2) in StbM_CloneConfigType
 **
 ** 0x00: No Rate correction to Destination Time Base.
 ** 0x01: Rate correction value of Source Time Base shall be applied to Destination Time Base.
 */
#define STBM_CLONE_APPLY_RATE           0x04U
 ...
 */
/* !LINKSTO StbM.SWS_StbM_00284.EV_GLOBAL_TIME_BASE,1 */
 ...
 ** 0: otherwise
 */
/* !LINKSTO StbM.SWS_StbM_00284.EV_TIMEOUT_OCCURED,1 */
 ...
 ** 0: otherwise
 */
/* !LINKSTO StbM.SWS_StbM_00284.EV_TIMEOUT_REMOVED,1 */
 ...
 ** 0: otherwise
 */
/* !LINKSTO StbM.SWS_StbM_00284.EV_TIMELEAP_FUTURE,1 */
 ...
 ** 0: otherwise
 */
/* !LINKSTO StbM.SWS_StbM_00284.EV_TIMELEAP_FUTURE_REMOVED,1 */
 ...
 ** 0: otherwise
 */
/* !LINKSTO StbM.SWS_StbM_00284.EV_TIMELEAP_PAST,1 */
 ...
 ** 0: otherwise
 */
/* !LINKSTO StbM.SWS_StbM_00284.EV_TIMELEAP_PAST_REMOVED,1 */
...
/* !LINKSTO StbM.EB.SWS_StbM_91009.ProvidedBy.StbM,1 */
/** \brief STBM_TIMESYNC_ETHERNET in StbM_TimeSyncType
 **
 ** 0x01:  Indicates Time Synchronization on Ethernet
 */
#ifndef STBM_TIMESYNC_ETHERNET
#define STBM_TIMESYNC_ETHERNET 1U
#endif

/** \brief STBM_TIMESYNC_CAN in StbM_TimeSyncType
 **
 ** 0x02:  Indicates Time Synchronization on CAN
 */
#ifndef STBM_TIMESYNC_CAN
#define STBM_TIMESYNC_CAN 2U
#endif

/** \brief STBM_TIMESYNC_FLEXRAY in StbM_TimeSyncType
 **
 ** 0x03:  Indicates Time Synchronization on Flexray
 */
#ifndef STBM_TIMESYNC_FLEXRAY
#define STBM_TIMESYNC_FLEXRAY 3U
#endif
 ...
 */
/* !LINKSTO StbM.SWS_StbM_00239,1 */
typedef VAR(uint8, TYPEDEF) StbM_TimeBaseStatusType;

#endif /* RTE_TYPE_StbM_TimeBaseStatusType */


#ifndef RTE_TYPE_StbM_CloneConfigType
/** \brief Enables the use of StbM's own definition for "StbM_CloneConfigType" type.*/
#define RTE_TYPE_StbM_CloneConfigType

/** \brief Represents how to configure the cloning process
 **
 ** Bit 3 .. 7 are always 0 (reserved for future usage).
 **
 ** Variables of this type are used to configure the cloning process.
 */
/* !LINKSTO StbM.SWS_StbM_91011,1 */
typedef VAR(uint8, TYPEDEF) StbM_CloneConfigType;

#endif /* RTE_TYPE_StbM_CloneConfigType */
...
#ifndef RTE_TYPE_StbM_TimeSyncType
/** \brief Enables the use of StbM's own definition for "StbM_TimeSyncType" type.*/
#define RTE_TYPE_StbM_TimeSyncType

/** \brief Indicates the underlying Time Sync module */
/* !LINKSTO StbM.EB.SWS_StbM_91009.ProvidedBy.StbM,1 */
typedef uint8 StbM_TimeSyncType;

#endif /* RTE_TYPE_StbM_TimeSyncType */


#ifndef RTE_TYPE_StbM_ProtocolParamType
/** \brief Enables the use of StbM's own definition for "StbM_ProtocolParamType" type.*/
#define RTE_TYPE_StbM_ProtocolParamType
/** \brief Defines TimeSync protocol specific parameters relevant for the individual TimeSync modules (only EthTSyn specific parameters are known so far)
 **
 ** This structure defines TimeSync protocol specific parameters relevant for the individual TimeSync modules
 ** (only EthTSyn specific parameters are known so far)
 */
/* !LINKSTO StbM.EB.SWS_StbM_91010.ProvidedBy.StbM,1 */
typedef struct
{
  VAR(StbM_TimeSyncType, TYPEDEF) protocolType;  /**< Indicates the underlying Time Sync module. */
  VAR(sint32, TYPEDEF) cumulativeScaledRateOffset;  /**< The cumulative rate offset of the Time Master acc. to IEEE 802.1AS */
  VAR(uint16, TYPEDEF) gmTimeBaseIndicator;  /**< The time base indicator of the current Global Time Master acc. to IEEE 802.1AS */
  VAR(sint32, TYPEDEF) lastGmPhaseChange;  /**< The phase change of the current Global Time Master acc. to IEEE 802.1AS */
  VAR(uint32, TYPEDEF) scaledLastGmFreqChange;  /**< The scaled last frequency change of the Global Time Master acc. to IEEE 802.1AS */
} StbM_ProtocolParamType;

#endif /* RTE_TYPE_StbM_ProtocolParamType */
