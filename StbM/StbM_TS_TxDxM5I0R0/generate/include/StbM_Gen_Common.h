...
#define STBM_SOURCE_TIMEBASES_USED                STD_[!IF "$StbMSourceTimebaseNumber > 0"!]ON[!ELSE!]OFF[!ENDIF!]
...
#define STBM_NUMBER_OF_SOURCE_TIMEBASES           [!"$StbMSourceTimebaseNumber"!]U
...
#define STBM_SETBUSPROTOCOLPARAM_ACTIVE          STD_[!IF "$syncMasterTimeBasesLinkedToEthTSynTimeDomain = 'true'"!]ON[!ELSE!]OFF[!ENDIF!]
...
#define STBM_GETBUSPROTOCOLPARAM_ACTIVE          STD_[!IF "$syncSlaveTimeBasesLinkedToEthTSynTimeDomain = 'true'"!]ON[!ELSE!]OFF[!ENDIF!]
