...
extern FUNC(Std_ReturnType, STBM_CODE) StbM_SetBusProtocolParam[!"$EcuCPartitionName"!]
(
  StbM_SynchronizedTimeBaseType timeBaseId,
...
extern FUNC(Std_ReturnType, STBM_CODE) StbM_GetBusProtocolParam[!"$EcuCPartitionName"!]
(
  StbM_SynchronizedTimeBaseType timeBaseId,
...
extern FUNC(Std_ReturnType, STBM_CODE) StbM_StartTimer[!"$EcuCPartitionName"!]
(
  StbM_SynchronizedTimeBaseType timeBaseId,
