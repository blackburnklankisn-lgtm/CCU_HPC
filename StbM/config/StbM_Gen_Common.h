...
#if (defined STBM_SOURCE_TIMEBASES_USED)
#error STBM_SOURCE_TIMEBASES_USED is already defined.
#endif
/** \brief Whether there are source timebases configured */
#define STBM_SOURCE_TIMEBASES_USED                STD_OFF
...
#define STBM_RTE_USED                             STD_ON
/* !LINKSTO StbM.SWS_StbM_00307,1 */
...
#define STBM_TIME_RECORDING_USED                  STD_OFF
...
#define STBM_TIME_VALIDATION_SUPPORT       STD_OFF
...
#define STBM_NOTIFICATION_OF_CUSTOMERS_USED                  STD_ON
...
#define STBM_GETCURRENTTIMEEXTENDED_USED                  STD_OFF
...
#define STBM_SYNC_SLAVE_TIMEBASES_CONFIGURED              STD_ON
...
#define STBM_NUMBER_OF_SYNC_TIMEBASES             1U
...
#define STBM_NUMBER_OF_PURE_TIMEBASES             1U
...
#define STBM_NUMBER_OF_OFFSET_TIMEBASES           0U

#if (defined STBM_NUMBER_OF_SOURCE_TIMEBASES)
#error STBM_NUMBER_OF_SOURCE_TIMEBASES is already defined.
#endif
/** \brief Number of configured source time bases. */
#define STBM_NUMBER_OF_SOURCE_TIMEBASES           0U
...
#define STBM_MASTER_RATE_CORRECTION_USED          STD_OFF
...
#define STBM_GET_MASTERCONFIG_SUPPORTED                STD_ON
...
#define STBM_SETOFFSET_SUPPORTED                STD_OFF
...
#define STBM_TRIGGERTIMETRANSMISSION_SUPPORTED                STD_ON
...
#define STBM_MASTER_OR_GATEWAY_TIME_BASE_CONFIGURED                STD_ON
...
#define STBM_MULTICORE_SUPPORTED                  STD_ON
...
#if (defined STBM_SETBUSPROTOCOLPARAM_ACTIVE)
#error STBM_SETBUSPROTOCOLPARAM_ACTIVE is already defined.
#endif
/** \brief Enables/disables StbM_SetBusProtocolParam API */
#define STBM_SETBUSPROTOCOLPARAM_ACTIVE          STD_ON
...
#if (defined STBM_GETBUSPROTOCOLPARAM_ACTIVE)
#error STBM_GETBUSPROTOCOLPARAM_ACTIVE is already defined.
#endif
/** \brief Enables/disables StbM_GetBusProtocolParam API */
#define STBM_GETBUSPROTOCOLPARAM_ACTIVE          STD_ON
