...
FUNC(Std_ReturnType, STBM_CODE) StbM_GetMasterConfig_EcucPartition_M7
(
...
FUNC(Std_ReturnType, STBM_CODE) StbM_SetGlobalTime_EcucPartition_M7
(
  StbM_SynchronizedTimeBaseType timeBaseId,
...
FUNC(Std_ReturnType, STBM_CODE) StbM_SetBusProtocolParam_EcucPartition_M7
(
  StbM_SynchronizedTimeBaseType timeBaseId,
...
)
{
  ...
  RetVal = StbM_SetBusProtocolParam(timeBaseId, protocolParam);
...
#if (STBM_MASTER_OR_GATEWAY_TIME_BASE_CONFIGURED == STD_ON)
FUNC(Std_ReturnType, STBM_CODE) StbM_SetUserData_EcucPartition_M7
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2CONST(StbM_UserDataType, AUTOMATIC, STBM_APPL_DATA) userData
)
...
FUNC(Std_ReturnType, STBM_CODE) StbM_TriggerTimeTransmission_EcucPartition_M7
(
  StbM_SynchronizedTimeBaseType timeBaseId
)
{
...
#if (STBM_MASTER_OR_GATEWAY_TIME_BASE_CONFIGURED == STD_ON)
FUNC(Std_ReturnType, STBM_CODE) StbM_UpdateGlobalTime_EcucPartition_M7
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2CONST(StbM_TimeStampType, AUTOMATIC, STBM_APPL_DATA) timeStamp,
  P2CONST(StbM_UserDataType, AUTOMATIC, STBM_APPL_DATA) userData
...
FUNC(Std_ReturnType, STBM_CODE) StbM_SetOffset_EcucPartition_M7
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2CONST(StbM_TimeStampType, AUTOMATIC, STBM_APPL_DATA) timeStamp,
  P2CONST(StbM_UserDataType, AUTOMATIC, STBM_APPL_DATA) userData
...
FUNC(Std_ReturnType, STBM_CODE) StbM_SetRateCorrection_EcucPartition_M7
(
  StbM_SynchronizedTimeBaseType timeBaseId,
...
FUNC(Std_ReturnType, STBM_CODE) StbM_GetCurrentTime_EcucPartition_M7
(
  StbM_SynchronizedTimeBaseType timeBaseId,
...
FUNC(Std_ReturnType, STBM_CODE) StbM_GetBusProtocolParam_EcucPartition_M7
(
  StbM_SynchronizedTimeBaseType timeBaseId,
...
)
{
  ...
  RetVal = StbM_GetBusProtocolParam(timeBaseId, protocolParam);
...
FUNC(Std_ReturnType, STBM_CODE) StbM_GetCurrentTimeExtended_EcucPartition_M7
(
  StbM_SynchronizedTimeBaseType timeBaseId,
...
FUNC(Std_ReturnType, STBM_CODE) StbM_GetRateDeviation_EcucPartition_M7
(
  StbM_SynchronizedTimeBaseType timeBaseId,
...
FUNC(Std_ReturnType, STBM_CODE) StbM_GetSyncTimeRecordHead_EcucPartition_M7
(
  StbM_SynchronizedTimeBaseType timeBaseId,
...
FUNC(Std_ReturnType, STBM_CODE) StbM_GetOffsetTimeRecordHead_EcucPartition_M7
(
  StbM_SynchronizedTimeBaseType timeBaseId,
...
FUNC(Std_ReturnType, STBM_CODE) StbM_GetTimeBaseStatus_EcucPartition_M7
(
  StbM_SynchronizedTimeBaseType timeBaseId,
...
FUNC(Std_ReturnType, STBM_CODE) StbM_GetTimeLeap_EcucPartition_M7
(
  StbM_SynchronizedTimeBaseType timeBaseId,
...
FUNC(Std_ReturnType, STBM_CODE) StbM_StartTimer_EcucPartition_M7
(
  StbM_SynchronizedTimeBaseType timeBaseId,
...
)
{
  ...
  RetVal = StbM_StartTimer(timeBaseId, customerId, expireTime);
...
#if (STBM_GET_MASTERCONFIG_SUPPORTED == STD_ON)
FUNC(Std_ReturnType, STBM_CODE) StbM_GetMasterConfig_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2VAR(StbM_MasterConfigType, AUTOMATIC, STBM_APPL_DATA) masterConfig
)
...
#if (STBM_MASTER_OR_GATEWAY_TIME_BASE_CONFIGURED == STD_ON)
FUNC(Std_ReturnType, STBM_CODE) StbM_SetGlobalTime_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2CONST(StbM_TimeStampType, AUTOMATIC, STBM_APPL_DATA) timeStamp,
  P2CONST(StbM_UserDataType, AUTOMATIC, STBM_APPL_DATA) userData
...
#if (STBM_SETBUSPROTOCOLPARAM_ACTIVE == STD_ON)
FUNC(Std_ReturnType, STBM_CODE) StbM_SetBusProtocolParam_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2CONST(StbM_ProtocolParamType, AUTOMATIC, STBM_APPL_DATA) protocolParam
)
...
#if (STBM_MASTER_OR_GATEWAY_TIME_BASE_CONFIGURED == STD_ON)
FUNC(Std_ReturnType, STBM_CODE) StbM_SetUserData_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2CONST(StbM_UserDataType, AUTOMATIC, STBM_APPL_DATA) userData
)
...
#if (STBM_TRIGGERTIMETRANSMISSION_SUPPORTED == STD_ON)
FUNC(Std_ReturnType, STBM_CODE) StbM_TriggerTimeTransmission_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId
)
{
...
#if (STBM_MASTER_OR_GATEWAY_TIME_BASE_CONFIGURED == STD_ON)
FUNC(Std_ReturnType, STBM_CODE) StbM_UpdateGlobalTime_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2CONST(StbM_TimeStampType, AUTOMATIC, STBM_APPL_DATA) timeStamp,
  P2CONST(StbM_UserDataType, AUTOMATIC, STBM_APPL_DATA) userData
...
#if (STBM_SETOFFSET_SUPPORTED == STD_ON)
FUNC(Std_ReturnType, STBM_CODE) StbM_SetOffset_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2CONST(StbM_TimeStampType, AUTOMATIC, STBM_APPL_DATA) timeStamp,
  P2CONST(StbM_UserDataType, AUTOMATIC, STBM_APPL_DATA) userData
...
#if(STBM_MASTER_RATE_CORRECTION_USED == STD_ON)
FUNC(Std_ReturnType, STBM_CODE) StbM_SetRateCorrection_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  StbM_RateDeviationType rateDeviation
)
...
FUNC(Std_ReturnType, STBM_CODE) StbM_GetCurrentTime_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2VAR(StbM_TimeStampType, AUTOMATIC, STBM_APPL_DATA) timeStamp,
  P2VAR(StbM_UserDataType, AUTOMATIC, STBM_APPL_DATA) userData
...
#if (STBM_GETBUSPROTOCOLPARAM_ACTIVE == STD_ON)
FUNC(Std_ReturnType, STBM_CODE) StbM_GetBusProtocolParam_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2VAR(StbM_ProtocolParamType, AUTOMATIC, STBM_APPL_DATA) protocolParam
)
...
#if (STBM_GETCURRENTTIMEEXTENDED_USED == STD_ON)
FUNC(Std_ReturnType, STBM_CODE) StbM_GetCurrentTimeExtended_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2VAR(StbM_TimeStampExtendedType, AUTOMATIC, STBM_APPL_DATA) timeStamp,
  P2VAR(StbM_UserDataType, AUTOMATIC, STBM_APPL_DATA) userData
...
FUNC(Std_ReturnType, STBM_CODE) StbM_GetRateDeviation_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2VAR(StbM_RateDeviationType, AUTOMATIC, STBM_APPL_DATA) rateDeviation
)
...
#if ((STBM_SYNC_TIME_RECORDING_USED == STD_ON) || (STBM_OFFSET_TIME_RECORDING_USED == STD_ON))
#if (STBM_SYNC_TIME_RECORDING_USED == STD_ON)
FUNC(Std_ReturnType, STBM_CODE) StbM_GetSyncTimeRecordHead_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2VAR(StbM_SyncRecordTableHeadType, AUTOMATIC, STBM_APPL_DATA) syncRecordTableHead
)
...
#if (STBM_OFFSET_TIME_RECORDING_USED == STD_ON)
FUNC(Std_ReturnType, STBM_CODE) StbM_GetOffsetTimeRecordHead_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2VAR(StbM_OffsetRecordTableHeadType, AUTOMATIC, STBM_APPL_DATA) offsetRecordTableHead
)
...
FUNC(Std_ReturnType, STBM_CODE) StbM_GetTimeBaseStatus_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2VAR(StbM_TimeBaseStatusType, AUTOMATIC, STBM_APPL_DATA) syncTimeBaseStatus,
  P2VAR(StbM_TimeBaseStatusType, AUTOMATIC, STBM_APPL_DATA) offsetTimeBaseStatus
...
#if(STBM_SYNC_SLAVE_TIMEBASES_CONFIGURED == STD_ON)
FUNC(Std_ReturnType, STBM_CODE) StbM_GetTimeLeap_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  P2VAR(StbM_TimeDiffType, AUTOMATIC, STBM_APPL_DATA) timeJump
)
...
#if (STBM_NOTIFICATION_OF_CUSTOMERS_USED == STD_ON)
FUNC(Std_ReturnType, STBM_CODE) StbM_StartTimer_EcucPartition_M7_1
(
  StbM_SynchronizedTimeBaseType timeBaseId,
  StbM_CustomerIdType customerId,
  P2CONST(StbM_TimeStampType, AUTOMATIC, STBM_APPL_DATA) expireTime
