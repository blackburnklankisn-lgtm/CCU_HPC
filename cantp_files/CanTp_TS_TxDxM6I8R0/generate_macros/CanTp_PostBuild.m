...
6) Check if all NSdus and NPdus from a CanTp channel are referencing the same partition, as the CanTpChannelProcessing node that refers the respective channel.
*/!][!IF "CanTpGeneral/CanTpMultiCoreSupport = 'true'"!][!/*
 */!][!LOOP "as:modconf('CanTp')[1]/CanTpGeneral/CanTpChannelProcessing/*/CanTpChannelRef/*"!][!/*
     */!][!VAR "partitionref" = "node:value(../../CanTpEcucPartitionRef)"!][!/*
      
     */!][!FOR "I"="1" TO "num:i(count(as:ref(.)/CanTpRxNSdu/*))"!][!/*
          */!][!IF "not(num:i(count(as:ref(as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpRxNSduRef)/EcucPduDedicatedPartition/*[EcucPduDedicatedPartitionBswModuleRef = 'ASPath:/CanTp/CanTp' and EcucPduDedicatedPartitionRef = $partitionref])) > num:i(0))"!][!/*
               */!][!IF "not(as:ref(as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpRxNSduRef)/EcucPduDefaultPartitionRef = $partitionref)"!][!/*
                */!][!ERROR!]RxNsdu [!"node:value(as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpRxNSduRef)"!] should reffer to partition [!"$partitionref"!] through EcucPduDedicatedPartitionRef or EcucPduDefaultPartitionRef.[!ENDERROR!][!/*
               */!][!ENDIF!][!/*
           */!][!ENDIF!][!/*
     */!][!ENDFOR!][!/*
     
     */!][!FOR "I"="1" TO "num:i(count(as:ref(.)/CanTpTxNSdu/*))"!][!/*
        */!][!IF "not(num:i(count(as:ref(as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpTxNSduRef)/EcucPduDedicatedPartition/*[EcucPduDedicatedPartitionBswModuleRef = 'ASPath:/CanTp/CanTp' and EcucPduDedicatedPartitionRef = $partitionref])) > num:i(0))"!][!/*
             */!][!IF "not(as:ref(as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpTxNSduRef)/EcucPduDefaultPartitionRef = $partitionref)"!][!/*
             */!][!ERROR!]TxNsdu [!"node:value(as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpTxNSduRef)"!] should reffer to partition [!"$partitionref"!] through EcucPduDedicatedPartitionRef or EcucPduDefaultPartitionRef.[!ENDERROR!][!/*
             */!][!ENDIF!][!/*
        */!][!ENDIF!][!/*
     */!][!ENDFOR!][!/*
     
     */!][!FOR "I"="1" TO "num:i(count(as:ref(.)/CanTpTxNSdu/*))"!][!/*
       */!][!IF "not(num:i(count(as:ref(as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpTxNPdu/CanTpTxNPduRef)/EcucPduDedicatedPartition/*[EcucPduDedicatedPartitionBswModuleRef = 'ASPath:/CanTp/CanTp' and EcucPduDedicatedPartitionRef = $partitionref])) > num:i(0))"!][!/*
          */!][!IF "not(as:ref(as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpTxNPdu/CanTpTxNPduRef)/EcucPduDefaultPartitionRef = $partitionref)"!][!/*
            */!][!ERROR!]CanTpTxNPduRef [!"node:value(as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpTxNPdu/CanTpTxNPduRef)"!] should reffer to partition [!"$partitionref"!] through EcucPduDedicatedPartitionRef or EcucPduDefaultPartitionRef.[!ENDERROR!][!/*
          */!][!ENDIF!][!/*
        */!][!ENDIF!][!/*
     */!][!ENDFOR!][!/*
     
     */!][!FOR "I"="1" TO "num:i(count(as:ref(.)/CanTpRxNSdu/*))"!][!/*
       */!][!IF "not(num:i(count(as:ref(as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpRxNPdu/CanTpRxNPduRef)/EcucPduDedicatedPartition/*[EcucPduDedicatedPartitionBswModuleRef = 'ASPath:/CanTp/CanTp' and EcucPduDedicatedPartitionRef = $partitionref])) > num:i(0))"!][!/*
         */!][!IF "not(as:ref(as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpRxNPdu/CanTpRxNPduRef)/EcucPduDefaultPartitionRef = $partitionref)"!][!/*
            */!][!ERROR!]CanTpRxNPduRef [!"node:value(as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpRxNPdu/CanTpRxNPduRef)"!] should reffer to partition [!"$partitionref"!] through EcucPduDedicatedPartitionRef or EcucPduDefaultPartitionRef.[!ENDERROR!][!/*
           */!][!ENDIF!][!/*
       */!][!ENDIF!][!/*
     */!][!ENDFOR!][!/*
     
     */!][!FOR "I"="1" TO "num:i(count(as:ref(.)/CanTpRxNSdu/*))"!][!/*
     */!][!IF "as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpRxTaType = 'CANTP_PHYSICAL'"!][!/*
       */!][!IF "not(num:i(count(as:ref(as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpTxFcNPdu/CanTpTxFcNPduRef)/EcucPduDedicatedPartition/*[EcucPduDedicatedPartitionBswModuleRef = 'ASPath:/CanTp/CanTp' and EcucPduDedicatedPartitionRef = $partitionref])) > num:i(0))"!][!/*
           */!][!IF "not(as:ref(as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpTxFcNPdu/CanTpTxFcNPduRef)/EcucPduDefaultPartitionRef = $partitionref)"!][!/*
            */!][!ERROR!]CanTpTxFcNPduRef [!"node:value(as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpTxFcNPdu/CanTpTxFcNPduRef)"!] should reffer to partition [!"$partitionref"!] through EcucPduDedicatedPartitionRef or EcucPduDefaultPartitionRef.[!ENDERROR!][!/*
           */!][!ENDIF!][!/*
       */!][!ENDIF!][!/*
     */!][!ENDIF!][!/*
     */!][!ENDFOR!][!/*
     ...
     */!][!FOR "I"="1" TO "num:i(count(as:ref(.)/CanTpTxNSdu/*))"!][!/*
     */!][!IF "as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpTxTaType = 'CANTP_PHYSICAL'"!][!/*
       */!][!IF "not(num:i(count(as:ref(as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpRxFcNPdu/CanTpRxFcNPduRef)/EcucPduDedicatedPartition/*[EcucPduDedicatedPartitionBswModuleRef = 'ASPath:/CanTp/CanTp' and EcucPduDedicatedPartitionRef = $partitionref])) > num:i(0))"!][!/*
          */!][!IF "not(as:ref(as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpRxFcNPdu/CanTpRxFcNPduRef)/EcucPduDefaultPartitionRef = $partitionref)"!][!/*
            */!][!ERROR!]CanTpRxFcNPduRef [!"node:value(as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpRxFcNPdu/CanTpRxFcNPduRef)"!] should reffer to partition [!"$partitionref"!] through EcucPduDedicatedPartitionRef or EcucPduDefaultPartitionRef.[!ENDERROR!][!/*
          */!][!ENDIF!][!/*
        */!][!ENDIF!][!/*
     */!][!ENDIF!][!/*
     */!][!ENDFOR!][!/*
