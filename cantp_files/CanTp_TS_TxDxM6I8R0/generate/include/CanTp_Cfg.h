...
[!IF "CanTpGeneral/CanTpFixedRxPduLengthSupport = 'true'"!][!//
#define CANTP_FIXED_NPDU_LENGTH_SUPPORT STD_ON
[!ELSE!][!//
...
#endif
#define CANTP_MULTICORE_SUPPORT           [!//
[!IF "as:modconf('CanTp')[1]/CanTpGeneral/CanTpMultiCoreSupport = 'true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
#endif
#define CANTP_DISTRIBUTED_CHANNEL_SUPPORT           [!//
[!IF "as:modconf('CanTp')[1]/CanTpGeneral/CanTpDedicatedChannelProcessingSupport = 'true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
#endif
#define CANTP_NUMBER_CONFIGURED_CHANNELS [!"num:i(count(CanTpConfig/*[1]/CanTpChannel/*))"!]U

[!IF "CanTpGeneral/CanTpDedicatedChannelProcessingSupport = 'true'"!]
[!LOOP "as:modconf('CanTp')[1]/CanTpGeneral/CanTpChannelProcessing/*"!]
/** \brief CanTp partition index*/
#if (defined CANTP_PARTITION_[!"num:i(node:pos(.))"!])
#error CANTP_PARTITION_[!"num:i(node:pos(.))"!] already defined
#endif
#define CANTP_PARTITION_[!"num:i(node:pos(.))"!]                    [!"num:i(node:pos(.))"!]U
[!ENDLOOP!]

/** \brief Number of configured CanTp main functions*/
#if (defined CANTP_MAIN_PARTITION)
#error CANTP_MAIN_PARTITION already defined
#endif
#define CANTP_MAIN_PARTITION [!"num:i(count(CanTpGeneral/CanTpChannelProcessing/*))"!]U
[!ENDIF!]
