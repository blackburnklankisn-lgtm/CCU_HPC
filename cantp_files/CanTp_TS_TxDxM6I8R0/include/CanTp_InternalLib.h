...
#if (defined CANTP_POSTPONED_FLAGS_MASK) /* to prevent double declaration */
#error CANTP_POSTPONED_FLAGS_MASK is already defined
#endif /* if (defined CANTP_POSTPONED_FLAGS_MASK) */
#define CANTP_POSTPONED_FLAGS_MASK       0x07U   /* 0000 0111 */
...
#define CANTP_CALCULATE_CANID_METADATA(tatype, nsa, nta) \
    (((tatype) != 0U) ? ((uint32)((0x18DB0000U) | ((uint32)(nta) << 8U) | (uint32)(nsa))) : \
