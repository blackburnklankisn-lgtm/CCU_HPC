...
typedef struct /* CanTp_ConfigLayoutType */ {
    ...
    VAR( CanTp_RxNPduLookupEntryType, TYPEDEF ) RxNPduLookupTable[58];
    VAR( CanTp_RxNPduTableType, TYPEDEF ) RxNPduTable[114];
    VAR( CanTp_RxNSduConfigType, TYPEDEF ) RxNSduConfig[57];
    VAR( CanTp_TxNSduConfigType, TYPEDEF ) TxNSduConfig[69];
    VAR( CanTp_MfCtrConfigType, TYPEDEF ) MfCtrConfig[69];
    VAR( CanTp_TxNPduToTpChannelType, TYPEDEF ) TxNPduToTpChannel[69];
